...
def get_text(indicate, _fin_, _predmetDog_, _adressDog_):
    ...
    dolg = ["1. ПРЕДМЕТ ДОГОВОРА",
            ...
            f"1.2.	Подъемное оборудование {_predmetDog_} расположено по адресу: {_adressDog_}",
            ...
            f"3.5.	Источник финансирования - {_fin_}",
